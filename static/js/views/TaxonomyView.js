...
export default {
  ...
  setup(props) {
    ...
    const {
      pageData, loading, error, currentPage, totalPages, paginatedList, isIndexMode, fetchData
    ...
    return {
      pageData, loading, error, currentPage, totalPages, paginatedList, isIndexMode, headerIcon, normalizedType, t
    };
  }
};
