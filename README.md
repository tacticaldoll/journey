...
Journey is an ultra-modern, **Single Page Application (SPA)** Hugo theme built with Vue.js and Vuetify. It strictly adheres to the **Antigravity Design System (GDD)**, delivering a premium visual experience, fluid page transitions, and robust full-site navigation without page reloads.
...
- **Custom Code Hooks**:
    ...
    MANDATORY READING: [Development Guide (GUIDE.md)](./GUIDE.md) for architectural details and GDD mandates.
...
> [!IMPORTANT]
> **Antigravity-Native Governance Protocol**: 
> 1. This project strictly relies on an **Antigravity-Native Governance** structure (Guideline-Driven Development). AI agents and developers **MUST** adhere to the executable boundaries in `.agent/skills/` and read the [Development Guide (GUIDE.md)](./GUIDE.md) before implementing any features or modifications.
