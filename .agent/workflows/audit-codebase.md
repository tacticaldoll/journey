...
1. Execute `python .agent/scripts/verify-vendor.py` (or equivalent verification script) to ensure that the local `static/vendor/` directory has not been manually altered by developers.
