...
This is the central intelligence and governance directory for the **Journey** theme project. It follows the **Antigravity Native Protocol** for Agent-Native **Guideline-Driven Development (GDD)**.
