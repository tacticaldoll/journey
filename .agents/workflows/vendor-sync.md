...
1. Create a `scripts/vendor_utils.py` to handle shared path and JSON loading logic.
2. Create a Python script named `scripts/download-vendor.py`.
3. This script MUST:
...
4. Auto-run the script to download all assets. (`python scripts/download-vendor.py`) (// turbo)
